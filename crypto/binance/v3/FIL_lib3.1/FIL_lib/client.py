...
class FILClient(object):
    ...
    def insertMarketQOrder(self, gateway_type:str, symbol:str, quantity:float, side:str):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
    ...
    def insertMarketTOrder(self, gateway_type:str, symbol:str, quantity:float, side:str):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
