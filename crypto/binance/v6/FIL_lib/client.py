...
class Handler(object):
    ...
    def handleRiskLimit(self, data:OrderType):
        logger.debug(f"RiskLimit: {data}")
...
class FILClient(object):
    ...
    def queryPrice(self, gateway_type:str, symbol:str):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return CommonReturn()
        data = {
            "method": "queryPrice",
            "params": [symbol,gateway_enum]
        }
        return self.__post(data, CommonReturn)

    def queryUPrice(self, gateway_type:str, symbol:str):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return CommonReturn()
    ...
    def queryTPrice(self, gateway_type:str, symbol:str):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return CommonReturn()
    ...
    def queryBinanceUPremiumIndex(self, symbol:str):
        data = {
            "method": "queryBinanceUPremiumIndex",
            "params": [symbol]
        }
        return self.__post(data, UPremiumIndexsReturn)
    ...
    def queryTradeContractAssets(self, asset:str, symbol:str):
        data = {
            "method": "queryTradeContractAssets",
            "params": [self.name, asset, symbol]
        }
        return self.__post(data, ContractAssetReturn)

    def queryLimitTradeContractAssets(self, asset:str, symbol:str, price:str):
        data = {
            "method": "queryLimitTradeContractAssets",
            "params": [self.name, asset, symbol, price]
        }
        return self.__post(data, ContractAssetReturn)
    ...
    def insertLimitUOrder(self, gateway_type:str, symbol:str, quantity:float, price:float, side:str, positionside:int):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
        ...
        data = {
            ...
            "params": [self.name, gateway_enum, order, positionside]
        }
        return self.__post(data, InsertOrderReturn)

    def insertMarketUOrder(self, gateway_type:str, symbol:str, quantity:float, side:str, positionside:int):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
    ...
    def insertLimitMakerUOrder(self, gateway_type:str, symbol:str, quantity:float, price:float, side:str, positionside:int):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
    ...
    def insertLossMarketUOrder(self, gateway_type:str, symbol:str, quantity:float, stopPrice:float, side:str, positionside:int):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
    ...
    def insertLossLimitUOrder(self, gateway_type:str, symbol:str, quantity:float, price:float, stopPrice:float, side:str, positionside:int):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
    ...
    def insertProfitMarketUOrder(self, gateway_type:str, symbol:str, quantity:float, stopPrice:float, side:str, positionside:int):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
    ...
    def insertProfitLimitUOrder(self, gateway_type:str, key_id:int, symbol:str, quantity:float, price:float, stopPrice:float, side:str, positionside:int):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
    ...
    def insertMarketQOrder(self, gateway_type:str, symbol:str, quantity:float, side:str, positionside:int):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
        ...
        order["side"] = side.upper()
        data = {
            "method": "insertMarketQOrder",
            "params": [self.name, gateway_enum, order, positionside]
        }
        return self.__post(data, InsertOrderReturn)

    def insertMarketTOrder(self, gateway_type:str, symbol:str, quantity:float, side:str, positionside:int):
        gateway_enum = GatewayTypeEnum.index(gateway_type)
        if gateway_enum == -1:
            logger.error("wrong gateway type")
            return InsertOrderReturn()
