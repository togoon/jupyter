...
class Binance(object):
    ...
    def qry_balance(self):
        ...
        if 'code' in rt and 'msg' in rt:
            ...
            for bal in rt:
                ...
                df_balance.to_pickle(f'{g_pkl_dir}/balancedf.pkl' )
    ...
    def qry_account(self):
        ...
        if 'code' in rt and 'msg' in rt:
            ...
            for ass in rt["assets"]:
                ...
                df_account.to_pickle('%s/%s.pkl' % (g_pkl_dir, "accountdf" ) )
            ...
            for posi in rt["positions"]:
                ...
                df_position.to_pickle('%s/%s.pkl' % (g_pkl_dir, "positiondf" ) )
    ...
    def trade_future(self, symbol='btcusdt', side='BUY', price=-1, quantity=0.001, orderType='MARKET', timeInForce='GTC'):
        ...
        if 'code' in rt and 'msg' in rt:
            ...
            df_order.to_pickle(f'{g_pkl_dir}/orderdf.pkl' )
...
# nohup python3 -u main.py -n similarity -X BTCUSDT -p 10m -w 42 -d 84  >> log.txt 2>&1  &
