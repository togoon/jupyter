...
# nohup python3 -u main_risk1.py -n testorder1 -s 8889 -c 39191 -X BTCUSDT -p 3m -w 40 -d 3 -T 0.5 -t 7500  >> log_risk1.log 2>&1 &

# nohup python3 -u main_order1.py -n testorder1 -s 8889 -c 39195 -X BTCUSDT -p 3m -w 40 -d 3 -T 0.5 -t 7500  >> log_risk1.log 2>&1 &
