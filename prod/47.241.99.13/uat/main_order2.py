...
# nohup python3 -u main_risk2.py -n testorder2 -s 8889 -c 39192 -X BTCUSDT -p 3m -w 40 -d 3 -T 0.5 -t 7500  >> log_risk2.log 2>&1 &

# nohup python3 -u main_order2.py -n testorder2 -s 8889 -c 39196 -X BTCUSDT -p 3m -w 40 -d 3 -T 0.5 -t 7500  >> log_risk2.log 2>&1 &
