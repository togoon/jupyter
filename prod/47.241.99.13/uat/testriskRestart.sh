...
ps aux | grep testorder | grep 8889 | grep -v grep | awk '{print $2}'| xargs kill -9
...
nohup python3 -u main_order1.py -n testorder1 -s 8889 -c 39195 -X BTCUSDT -p 3m -w 40 -d 3 -T 0.5 -t 7500  >> log_order1.log 2>&1 &

nohup python3 -u main_order2.py -n testorder2 -s 8889 -c 39196 -X BTCUSDT -p 3m -w 40 -d 3 -T 0.5 -t 7500  >> log_order2.log 2>&1 &
...
# nohup python3 -u main_order1.py -n testorder1 -s 8889 -c 39193 -X BTCUSDT -p 3m -w 40 -d 3 -T 0.5 -t 7500  >> log_order1.log 2>&1 &

# nohup python3 -u main_order2.py -n testorder2 -s 8889 -c 39194 -X BTCUSDT -p 3m -w 40 -d 3 -T 0.5 -t 7500  >> log_order2.log 2>&1 &
