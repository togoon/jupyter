...
# nohup python3 -u main_tactic.py -n testtrade1 -s 8889 -c 39290 -X BTCUSDT -p 10m -w 40 -d 2 -T 0.5 -t 1000 >> log.txt 2>&1 &

# python3 -u main_tactic.py -n testtrade1 -s 8889 -c 39290 -X BTCUSDT -p 10m -w 40 -d 2 -T 0.5 -t 1000
