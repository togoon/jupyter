...
def getWorth2():
    ...
    csvdf2.to_csv('%s/worth_%s2.csv' % ("/root/FIL/strategy/worth" , time.strftime("%Y%m%d") ), index=None)
    totalWorthdf2.to_pickle('%s/%s2.pkl' % ("/root/FIL/strategy/worth" , "totalWorthdf" ) )
